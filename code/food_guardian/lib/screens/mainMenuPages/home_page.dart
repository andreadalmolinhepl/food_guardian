...
class HomePage extends StatefulWidget {
  ...
  const HomePage(
      {Key? key, required this.onPageChanged, required this.scanBarcodeRequest})
      : super(key: key);
                      ...
                      Padding(
                        ...
                        child: Text(
                          FirebaseAuth.instance.currentUser != null
                              ? '${AppLocalizations.of(context)!.hi} ${FirebaseAuth.instance.currentUser!.displayName}'
                              : 'Hi there !',
                          style: kTitleHome,
                        ),
                      ),
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(AppLocalizations.of(context)!.yourLastScans,
                                style: kTextTabItem),
                            GestureDetector(
                              onTap: () {
                          ...
                          ? StreamBuilder<QuerySnapshot>(
                              ...
                              builder: (BuildContext context,
                                ...
                                if (snapshot.connectionState ==
                                  ...
                                  return Text(
                                      'Error: ${snapshot.error}'); //TODO
                                } else if (!snapshot.hasData ||
                                    snapshot.data!.docs.isEmpty) {
                                  return const Padding(
                                    padding: EdgeInsets.only(
                                        top: kVerticalPaddingXL),
                                    child: Column(
                                      children: [
                                        Image(
                                          image: AssetImage(
                                        ...
                                        Padding(
                                          padding: EdgeInsets.symmetric(
                                              ...
                                              vertical: kVerticalPadding),
                                          child: Text(
                                              "Once you scan something, your most recent scans will appear here",
                                  ...
                                  List<ProductSnippet> snippets =
                                    ...
                                    return ProductSnippet.fromMap(doc.id,
